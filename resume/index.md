...
## Projects of concern
- [x] <img src="" width=40 height=40/> [Contributions to jMonkeyEngine](https://github.com/jMonkeyEngine/jmonkeyengine/commits?author=Scrappers-glitch): jMonkeyEngine is a complete 3D game engine written primarily in java. It’s open-source, cross-platform, cutting-edge, minimalistic and code first approach.
...
- [x] <img src="https://github.com/Software-Hardware-Codesign/Serial4j-v1/blob/development/serial-4j-rounded-corners.png" height=40 width=45/> [Serial4j-v1](https://github.com/Software-Hardware-Codesign/Serial4j-v1): A java GNU/Linux terminal IO fully customizable library.
- [x] <img src="https://github.com/Scrappers-glitch/Superior-Extended-Engine/blob/master/SuperiorPlugin/src/main/java/com/scrappers/superiorExtendedEngine/attachments/LogoMod1.png" height=40 width=50/> [Superior-Extended-Engine](https://github.com/Monkey-Droid/Superior-Extended-Engine): An android GUI interfacing API collection for jMonkeyEngine games.
