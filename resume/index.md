...
# Skills:
Java (4 years) | C/C++ (3+ years) | Kotlin | Bash (Shell Scripting) | Software Architectural Design | Concurrent Programming | Object-oriented Design | Design Patterns | Game Programming Patterns | Entity-Component-System Design | Procedural Programming (Finite Automata) | Java Native Interface (JNI) | AVR Toolhchains | Android NDK Toolchains | GNU/Linux Libc | Kernel userspace APIs (IEEE-1284, RS232/Serial-USB) | Microcontroller Programming (GPIO, UART, I2C, SPI, ADC, PWM) | jMonkeyEngine Framework | Technical Datasheet Analysis | Embedded Systems Design (Decoders, Encoders, Circuit Design) | Realtime signal processing | Hardware/Software Co-design | Distributed Simulations | Hardware Prototyping | Soldering for assembly and repair | PCB Design | Kicad | Multimeters | Custom development modules | CMake | Git/GitHub VCS | GitHub Actions (CI/CD) | Gradle | Gradle Multi-project Builds | Valgrind | jconsole | GNU Debugger (GDB) | Sqlite DB | Data Structures | Algorithms | POSIX | GNU Compiler Collection (GCC) | Android SDK | Sonatype/Maven Deployment | Documentation writing | Latex | Dot for architectural diagrams (GraphViz) | Scientific Modelling | Computational Theory | Calculus | Linear Algebra | Medical and Clinical Sciences.
